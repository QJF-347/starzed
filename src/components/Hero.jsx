...
import ifpImage from '../assets/images/ifp_image.png';
import './Hero.css';
...
const slides = [
    ...
    },
    {
        ...
        title: "Global Advocates of",
        titleHighlight: "Peace Flag",
        description: "As Directors of Global Advocates of Peace Flag – Kenya Chapter, we champion conflict resolution, youth and women peace advocacy, and cross-border unity through flag hoisting ceremonies and community workshops.",
        image: globalPeaceHero,
        ctaText: "Learn More",
        link: "/global-peace-advocates"
    },
    {
        id: 11,
        badge: "Global Partnership",
        title: "International Family",
        titleHighlight: "Pageant (IFP)",
        description: "Celebrating leadership, cultural heritage, and family values. We partner with IFP to empower women, nurture youth leadership, and strengthen family-centric initiatives across Kenya.",
        image: ifpImage,
        ctaText: "Learn More",
        link: "/international-family-pageant"
    }
];
